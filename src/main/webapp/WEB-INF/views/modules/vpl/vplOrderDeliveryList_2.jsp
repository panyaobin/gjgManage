...
<form:form id="searchForm" modelAttribute="vplOrderDelivery" action="${ctx}/vpl/vplOrderDelivery" method="post" class="breadcrumb form-search">
    ...
    <ul class="ul-form">
        ...
        <li>出货单号：<input id="e" class="" name="deliveryId" value="${vplOrderDelivery.deliveryId}" style="width: 7em;" type="text" placeholder="出货单号"/>&nbsp;&nbsp;&nbsp;</li>
        <li>订单号：<input id="d" class="" name="orderId" value="${vplOrderDelivery.orderId}" style="width: 7em;" type="text" placeholder="订单号"/>&nbsp;&nbsp;&nbsp;</li>
        <li>出货日期：
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <tr>
        ...
        <th style="text-align: center">出货单号</th>
